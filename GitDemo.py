...
def wishMe():
    ...
    if hour>=0 and hour<12:
        speak("Good Morning Jhanavi")
    elif hour>=12 and hour<4:
        speak("Good Afternoon Jhanavi")
    else:
        speak("Good Evening Jhanavi")
...
def takeCommand():
    ...
    try:
        ...
        print("user Said: ", query)
           ...
           print(e)
           speak("Sorry, I cant here you, you voice is not audible please Repeat again")
           return "none"
    return query
...
if __name__=="__main__":
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            speak("I Didn't understand your command,try again")